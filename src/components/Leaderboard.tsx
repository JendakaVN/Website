            ...
            <div className="flex items-end justify-center gap-1 sm:gap-2 mb-8 h-24 sm:h-32 px-1">
              ...
              {top3[1] && (
                <div className="flex-1 flex flex-col items-center min-w-0 h-full justify-end">
                  ...
                  <div className="w-full bg-slate-400/20 border-t border-x border-slate-400/30 rounded-t-lg relative transition-all duration-500" style={{ height: '45%' }}>
              ...
              {top3[0] && (
                <div className="flex-1 flex flex-col items-center min-w-0 h-full justify-end">
                  ...
                  <div className="w-full bg-yellow-500/30 border-x border-t border-yellow-500/50 rounded-t-xl relative shadow-[0_0_20px_rgba(234,179,8,0.3)] transition-all duration-500" style={{ height: '95%' }}>
              ...
              {top3[2] && (
                <div className="flex-1 flex flex-col items-center min-w-0 h-full justify-end">
                  ...
                  <div className="w-full bg-orange-600/20 border-t border-x border-orange-600/30 rounded-t-lg relative transition-all duration-500" style={{ height: '18%' }}>
                    <div className="absolute -top-5 sm:-top-6 left-1/2 -translate-x-1/2">
